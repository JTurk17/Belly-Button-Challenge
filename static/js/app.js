...
function optionChanged(newSample) {
  ...
  //var new_top_OTU = newSample.otu_ids.slice(0,10).reverse();
  //var new_idMap = new_top_OTU.map(item => "OTU " + item);

  //Plotly.restyle("#bar", "x", [newSample[0].sample_values.slice(0,10).reverse()]);
  //Plotly.restyle("#bar", "y", [new_idMap]);

  //Plotly.restyle("#bubble", "x", [newSample[0].otu_ids]);
  //Plotly.restyle("#bubble", "y", [newSample[0].sample_values]);
}
